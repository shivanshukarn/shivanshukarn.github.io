  ...
  return (
    <>
      <section className='text-center flex flex-col justify-center h-full'>
        ...
        <button type="submit" className="py-2 px-4 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-2 focus:outline-none focus:ring-primary-300 bg-[#007bff] hover:bg-blue-500 flex justify-center items-center gap-2">Download CV <FiDownload /></button>
        </div>
      </section>
    </>
  )
